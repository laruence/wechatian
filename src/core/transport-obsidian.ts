...
export class ObsidianTransport implements HttpTransport {
  ...
  private async run(
    ...
    // background. Accepted because this stack is mandatory for the ilink
    // gateway (it TLS-fingerprints and 412s Node's http client); abort-capable
    // transfers (article fetches) use NodeTransport instead.
